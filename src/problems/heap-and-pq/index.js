...
import { kthSmallestInSortedMatrix } from "./kth-smallest-element-in-sorted-matrix";
import { kthSmallestSumOfMatrix } from "./kth-smallest-sum-in-row-sorted-matrix";
import { lastStoneWeight } from "./last-stone-weight";



// const kth = new KthLargest(7, [-10,1,3,1,4,10,3,9,4,5,1]);
// kth.dequeue();
// console.log(kth.queue);
...
// console.log(ipo(3, 0, [1,2,3], [0,1,2]));