...
import { spiralOrder } from "./spiral-traversal";

// console.log(countGoodNumbers(50));
// console.log(minStraightLines([[1, 7], [2, 6], [3, 5], [4, 4], [5, 4], [6, 3], [7, 2], [8, 1]]));
// console.log(new Array(10).fill(0).map((d, i) => nthFibonacci(i)));
// console.log(checkHappyNumber(7));
